                    ...
                    <form action="{{ route('admin.settings.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="form-body">
                            <div class="row p-t-20">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('about_title_ar') ? 'has-danger' : '' }}">
                                        ...
                                        @if ($errors->has('about_title_ar'))
                                            <small class="form-control-feedback">{{ $errors->first('about_title_ar') }}</small>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('about_title_en') ? 'has-danger' : '' }}">
                                        ...
                                        @if ($errors->has('about_title_en'))
                                            <small class="form-control-feedback">{{ $errors->first('about_title_en') }}</small>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group {{ $errors->has('about_title_tr') ? 'has-danger' : '' }}">
                                        <label class="control-label">Türkçe Title</label>
                                        <input type="text" name="about_title_tr" class="form-control"
                                               value="{{ $settings->about_title_tr ?? '' }}">
                                        @if ($errors->has('about_title_tr'))
                                            <small class="form-control-feedback">{{ $errors->first('about_title_tr') }}</small>
                                        @endif
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="about_description_ar">Arabic
                                            Description</label>
                                        <textarea name="about_description_ar" id="about_description_ar" cols="30"
                                                  rows="10"
                                                  class="mymce form-control">{{ isset($settings->about_description_ar) ? $settings->about_description_ar : '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="about_description_en">English
                                            Description</label>
                                        <textarea name="about_description_en" id="about_description_en" cols="30"
                                                  rows="10"
                                                  class="mymce form-control">{{ isset($settings->about_description_en) ? $settings->about_description_en : '' }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label" for="about_description_tr">Türkçe
                                            Description</label>
                                        <textarea name="about_description_tr" id="about_description_tr" cols="30"
                                                  rows="10"
                                                  class="mymce form-control">{{ isset($settings->about_description_tr) ? $settings->about_description_tr : '' }}</textarea>
                                    </div>
                                </div>
                                <!--/row-->
