<nav>
    <div class="nav-wrapper">
        ...
        @endif
        <ul dir="{{ config('app.locale') == 'ar' ? 'rtl' : '' }}" lang="{{ config('app.locale') == 'ar' ? 'ar' : '' }}" id="nav-mobile" class="right hide-on-med-and-down">
            <li><a href="/">Home</a></li>
            ...
            <li><a href="/lang/tr"><img src="{{asset('frontend/imgs/turkey.svg')}}" class="img-responsive" width="35" style="padding-top: 10px;"></a></li>
            <li><a href="/lang/en"><img src="{{asset('frontend/imgs/united-kingdom.svg')}}" class="img-responsive" width="35" style="padding-top: 10px;"></a></li>
            <!-- Dropdown Structure -->
        </ul>
        <a href="#" data-activates="slide-out" class="right button-collapse"><i class="material-icons">menu</i></a>
        <ul  dir="{{ config('app.locale') == 'ar' ? 'rtl' : '' }}" lang="{{ config('app.locale') == 'ar' ? 'ar' : '' }}" id="slide-out" class="side-nav">
            <a href="/" class="brand-logo">
                @if(isset($settings->logo) && $settings->logo !="")
                    <img src="{{url('/storage/'.$settings->logo)}}" width="200"></a>
            @endif>
